...
'pegawai.destroy',$peg->id) }}" method="POST">
 <a class="btn btn-sm btn-primary " href="{{ route('pegawai.show',$peg->id) }}"><i class="fa fa-fw fa-eye"></i> Lihat</a>
 <a class="btn btn-sm btn-success" href="{{ route('pegawai.edit',$peg->id) }}"><i class="fa fa-fw fa-edit"></i> Ubah</a>
